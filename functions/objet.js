// Creation of a class CalculDistance using the prototype property for the distance calculation functions
...
CalculDistance.prototype.calculDistance2PointsGPS = function (lat1, long1, lat2, long2) {
  ...
  return R * Math.acos(Math.sin(lat1) * Math.sin(lat2) + Math.cos(lat1) * Math.cos(lat2) * Math.cos(long2 - long1));
};
